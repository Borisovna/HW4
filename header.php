<?php //require ('class/class_db.php');
//session_start ();?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="navbar navbar-inverse navbar-fixed-top" style="margin-bottom: 100px">
    <div class="container">
...
//                        print_r ($_COOKIE);
                        ?></a></li>
                                <li>
<!--                                    <img src="--><?php //echo $_COOKIE['photo']; ?><!--"   width="49" height="49" style="border-radius: 50%; border: 2px solid white; ">-->
                                </li>
                                <li>
                                    <form  action="1.php" method='post'>
                                        <button  type='submit' class='btn btn-default'>Выйти</button>
                                    </form>
<!--                                    <a href="index.php">Выйти</a></li>-->
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</nav>
